...
export default function PageNotFound() {
  ...
  const pageName = (pathname ?? '').replace(/^\//, '') || 'unknown';
  ...
  const userRole = (authData?.user as UserWithRole | null | undefined)?.role;
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
      <div className="w-full max-w-md">
        <div className="space-y-6 text-center">
          ...
          {isFetched && authData?.isAuthenticated && userRole === 'admin' && (
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1 text-left">
                  ...
                  <p className="text-sm leading-relaxed text-slate-600">
                    This could mean that the AI hasn&apos;t implemented this page yet. Ask it to implement it in the
                    chat.
                  </p>
                </div>
              </div>
